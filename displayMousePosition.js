...
// We need a function to toggle wheather tracking is endabled
function toggleTracking() {
    // If isMouseTracking is true, set it to false
    // Otherwise it i false, and needs to be set to true
    isMouseTracking = !isMouseTracking;
    // Update the tracking status to show wheather it is enabled
    if (isMouseTracking) {
