function clearErrors() {
    for (var loopCounter = 0;
        ...
        if (document.forms["numberFun"].elements[loopCounter].parentElement.className.indexOf("has-") != -1) {
            ...
            documnet.forms["numberFun"].elements[loopCounter].parentElement.className = "form-group";
        }
    }
}
...
function validateItems() {
    ...
    if (num1 == "" || isNaN(num1)) {
        ...
        document.forms["numberFun"]["num1"].parentElemenet.className = "form-group has-error";
        document.forms["numberFun"]["num1"].focus();
        return false;
    }
    if (num2 == "" || isNaN(num2)) {
    ...
    //We are returning so that the form doesn't submit
